...
copy_if_not_exist "/etc/tel/ttc/${audio_avc}" "${NVM_ROOT_DIR}/${audio_avc}"
copy_if_not_exist "/etc/tel/ttc/${audio_config}" "${NVM_ROOT_DIR}/${audio_config}"
copy_if_not_exist "/etc/tel/ttc${audio_ctm}" "${NVM_ROOT_DIR}/${audio_ctm}"
copy_if_not_exist "/etc/tel/ttc/${audio_diamond}" "${NVM_ROOT_DIR}/${audio_diamond}"
copy_if_not_exist "/etc/tel/ttc/${audio_DualMic}" "${NVM_ROOT_DIR}/${audio_DualMic}"
copy_if_not_exist "/etc/tel/ttc/${audio_ec}" "${NVM_ROOT_DIR}/${audio_ec}"
copy_if_not_exist "/etc/tel/ttc/${audio_effect_config}" "${NVM_ROOT_DIR}/${audio_effect_config}"
copy_if_not_exist "/etc/tel/ttc/${audio_eq}" "${NVM_ROOT_DIR}/${audio_eq}"
copy_if_not_exist "/etc/tel/ttc/${audio_gain_calibration}" "${NVM_ROOT_DIR}/${audio_gain_calibration}"
copy_if_not_exist "/etc/tel/ttc/${audio_gssp_config}" "${NVM_ROOT_DIR}/${audio_gssp_config}"
copy_if_not_exist "/etc/tel/ttc/${audio_HLPF}" "${NVM_ROOT_DIR}/${audio_HLPF}"
copy_if_not_exist "/etc/tel/ttc/${audio_misc}" "${NVM_ROOT_DIR}/${audio_misc}"
copy_if_not_exist "/etc/tel/ttc/${audio_MSAmain}" "${NVM_ROOT_DIR}/${audio_MSAmain}"
copy_if_not_exist "/etc/tel/ttc/${audio_ns}" "${NVM_ROOT_DIR}/${audio_ns}"
copy_if_not_exist "/etc/tel/ttc/${audio_swvol_calibration}" "${NVM_ROOT_DIR}/${audio_swvol_calibration}"
